...
!function(){var $=jQuery,t=slideshow_jquery_image_gallery_script;t.Slideshow.prototype.recalculate=function(t){if(!this.$container.is(":visible"))return void setTimeout($.proxy(function(){this.recalculate(t)},this),500);for(var i=this.$parentElement,e=0;i.width()<=0&&(i=i.parent(),!(e>50));e++);if(this.currentWidth!=i.width()){this.currentWidth=i.width();var h=i.width()-(this.$container.outerWidth()-this.$container.width());if(parseInt(this.settings.maxWidth,10)>0&&parseInt(this.settings.maxWidth,10)<h&&(h=parseInt(this.settings.maxWidth,10)),this.$container.css("width",Math.round(h)),this.$content.css("width",Math.round(h)-(this.$content.outerWidth(!0)-this.$content.width())),this.settings.preserveSlideshowDimensions){var s=h*this.settings.dimensionHeight/this.settings.dimensionWidth;this.$container.css("height",Math.round(s)),this.$content.css("height",Math.round(s)-(this.$content.outerHeight(!0)-this.$content.height()))}if(0==this.settings.height){var s=i.height();this.$container.css("height",Math.round(s)),this.$content.css("height",Math.round(s))}else this.$container.css("height",Math.round(this.settings.height)),this.$content.css("height",Math.round(this.settings.height));this.$views.each($.proxy(function(t,i){$.inArray(t,this.visibleViews)<0&&$(i).css("top",this.$container.outerHeight(!0))},this)),this.$container.trigger("slideshowResize"),(t||"boolean"!=typeof t)&&this.recalculateVisibleViews()}},t.Slideshow.prototype.recalculateViews=function(){$.each(this.$views,$.proxy(function(t){this.recalculateView(t,!1)},this))},t.Slideshow.prototype.recalculateVisibleViews=function(){$.each(this.visibleViews,$.proxy(function(t,i){this.recalculateView(i,!1)},this))},t.Slideshow.prototype.recalculateView=function(i,e){if(this.$content.width()<=0||this.$content.height()<=0)return void setTimeout($.proxy(function(){this.recalculateView(i,e)},this),500);var h=$(this.$views[i]);if("boolean"==typeof e&&e||this.$content.width()!=h.outerWidth(!0)){var s=h.find(".slideshow_slide");if(!(s.length<=0)){var r=this.$content.width()-(h.outerWidth(!0)-h.width()),a=this.$content.height()-(h.outerHeight(!0)-h.height()),o=Math.floor(r/s.length),n=a,d=r%s.length,c=0;$(s[0]).css("margin-left",0),$(s[s.length-1]).css("margin-right",0),$.each(s,$.proxy(function(e,h){var r=$(h),a=r.outerWidth(!0)-r.width(),g=r.outerHeight(!0)-r.height();if(e==s.length-1?r.width(o-a+d):r.width(o-a),r.height(n-g),r.hasClass("slideshow_slide_text")){var l=r.find(".slideshow_background_anchor");if(l.length<=0)return;var u=r.width()-(l.outerWidth(!0)-l.width()),w=r.height()-(l.outerHeight(!0)-l.height());l.css({width:u,height:w})}else if(r.hasClass("slideshow_slide_image")){var f=r.find("img");if(f.length<=0)return;var v=f.outerWidth(),p=f.outerHeight(),m,y;m=isNaN(parseInt(v,10))?0:v-f.width(),y=isNaN(parseInt(p,10))?0:p-f.height();var M=r.width()-m,_=r.height()-y;"stretch"===this.settings.imageBehaviour?(f.css({width:M,height:_}),f.attr({width:M,height:_})):this.getNaturalImageSize(f,$.proxy(function(t,e){var h,s;return t<=0||e<=0?void setTimeout($.proxy(function(){this.recalculateView(i,!0)},this),500):(h=r.width()/r.height(),s=(t+m)/(e+y),void(s>=h?"natural"===this.settings.imageBehaviour?(f.css({margin:"0px",width:M,height:Math.round(M/s)}),f.attr({width:M,height:Math.round(M/s)})):"crop"===this.settings.imageBehaviour&&(f.css({"margin-top":"0px","margin-left":-Math.floor((_*s-M)/2),height:_,width:Math.floor(_*s)}),f.attr({width:Math.floor(_*s),height:_})):"natural"===this.settings.imageBehaviour?(f.css({"margin-left":"auto","margin-right":"auto",display:"block",width:Math.round(_*s),height:_}),f.attr({width:Math.round(_*s),height:_})):"crop"===this.settings.imageBehaviour&&(f.css({"margin-top":-Math.floor((M/s-_)/2),"margin-left":"0px",width:M,height:Math.floor(M/s)}),f.attr({width:M,height:Math.floor(M/s)}))))},this))}else if(r.hasClass("slideshow_slide_video")){var x=r.find("iframe");if(x.length>0)x.attr({width:r.width(),height:r.height()});else var W=setInterval($.proxy(function(){if(t.youTubeAPIReady){clearInterval(W);var i=r.find(".slideshow_slide_video_id");i.attr("id","slideshow_slide_video_"+Math.floor(1e6*Math.random())+"_"+i.text());var e=i.attr("data-show-related-videos"),h=new YT.Player(i.attr("id"),{width:r.width(),height:r.height(),videoId:i.text(),playerVars:{wmode:"opaque",rel:e},events:{onReady:function(){},onStateChange:$.proxy(function(t){this.videoPlayers[i.attr("id")].state=t.data},this)}}),s=$("#"+i.attr("id"));s.show(),s.attr("src",s.attr("src")+"&wmode=opaque"),this.videoPlayers[i.attr("id")]={player:h,state:-1}}},this),500)}c+=r.outerWidth(!0)},this)),h.css({width:r,height:a})}}}}();
